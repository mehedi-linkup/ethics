							...
							<div class="row">
								<div class="col-lg-5 col-md-6">
									<div class="footer-widget about-widget">
										...
										<ul class="list">
											<li>
												<h2><a href="">Organizational Overview</a></h2>
											</li>
											<li>
												<h2><a href="">How Ethics&#174; Works</a></h2>
											</li>
											<li>
												<h2><a href="">Six GUIDING Priciple of Ethics&#174;</a></h2>
											</li>
											<li>
												<h2><a href="">Write a testimonial for ETHICS&#174;</a></h2>
											</li>
										</ul>
								...
								<div class="col-lg-7 col-md-6">
									<div class="footer-widget membership-widget">
										...
										<ul class="list">
											<li>
												<h2><a href="">Become a Member</a></h2>
											</li>
											<li>
												<h2><a href="">Why Join Ethics&#174;</a></h2>
											</li>
											<li>
												<h2><a href="">Membership application form</a></h2>
											</li>
											<li>
												<h2><a href="">List of countries for ETHICS&#174; free</a></h2>
											</li>
											<li>
												<h2><a href="">Members directory</a></h2>
											</li>
											<li>
												<h2><a href="">Membership cancellation</a></h2>
											</li>
											<li>
												<h2><a href="">Membership Fee Structure</a></h2>
											</li>
											<li>
												<h2><a href="">Duties and Responsibilities of ETHICS&#174; Members</a></h2>
											</li>
											<li>
												<h2><a href="">Membership Forum</a></h2>
											</li>
										</ul>
									</div>
								</div>
							...
							<div class="row">
								<div class="col-lg-4 col-md-4">
									<div class="footer-widget code-widget">
										...
										<ul class="list">
											<li>
												<h2><a href="">Ethics Code for Publishers</a></h2>
											</li>
										</ul>
									</div>
